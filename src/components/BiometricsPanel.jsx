...
const BiometricsPanel = ({ stats }) => {
  ...
  return (
    ...
    >
      {/* L-shaped corner brackets frame - Faded (0.2 opacity) */}
      <div className="relative">
        <div className="absolute -top-2 -left-2 w-4 h-4 border-l border-t" style={{ borderColor: 'rgba(250, 204, 21, 0.2)' }} />
        <div className="absolute -top-2 -right-2 w-4 h-4 border-r border-t" style={{ borderColor: 'rgba(250, 204, 21, 0.2)' }} />
        <div className="absolute -bottom-2 -left-2 w-4 h-4 border-l border-b" style={{ borderColor: 'rgba(250, 204, 21, 0.2)' }} />
        <div className="absolute -bottom-2 -right-2 w-4 h-4 border-r border-b" style={{ borderColor: 'rgba(250, 204, 21, 0.2)' }} />
